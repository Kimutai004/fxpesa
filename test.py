...
def fetch_data():
    ...
    if response.status_code == 200:
        ...
        if 'Time Series FX (Daily)' in data:
            ...
            # Convert 'HIGH' column to float and coerce errors
    ...
    # Return an empty DataFrame if data fetching fails
    return pd.DataFrame()
...
def identify_wedge_patterns(data, window=20):
    ...
    if data.empty:
        ...
        # Handle this condition appropriately, such as exiting the program or returning
        # an empty list or DataFrame as necessary.
        exit()
